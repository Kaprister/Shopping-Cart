...
const Cart = () => {
    ...
    <div className=" flex justify-center items-center p-4 m-5 shadow-2xl shrink ">
  {
    ...
    (<div className=" flex gap-5 flex-col md:flex-row">
      ...
      <div className="cart-desc flex flex-row justify-around md:flex-col md:place-content-around ">
        ...
        <div className="flex flex-col gap-5">
          <p className=" font-semibold">Total Amount:<span className=" font-extrabold">${totalAmount.toFixed(2)}</span></p>
    ...
    (<div className=" flex flex-col gap-5 justify-center items-center">
      <h1 className=" text-[40px] m-3 p-3 rounded-md font-extrabold tracking-wide text-green-700">Cart Empty</h1>
      <Link to={"/"}>
